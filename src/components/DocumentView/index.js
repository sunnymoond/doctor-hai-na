                ...
                <View>
                  <Text
                    ...
                    style={{
                      ...
                      paddingHorizontal: scaleHeight * 60,
                      fontSize: Typography.FONT_SIZE_16,
                      color: this.props.item.status === "2" 
                      ? this.props.theme.RED : this.props.item.status === "1" 
                      ? this.props.theme.GREEN : this.props.theme.BUTTON_BACKGROUND_COLOR,
                      fontWeight: "bold",
                    }}
                  >
                    {this.props.item.status === "2" 
                      ? 'REJECT' : this.props.item.status === "1" 
                      ? 'APPROVED': 'PENDING'}
                  </Text>
                </View>
